...
namespace SıgnalRWebUI.Controllers
{
    public class SocialMediaController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7001/api/SocialMedias");//GetAsync HttpClient da var olan metot.Nereye Get isteğinde bulunacaksam orada var olan adresi alıyorum. 
        ...
        public async Task<IActionResult> CreateSocialMedia(CreateSocialMediaDto createSocialMediaDto)
        {
            ...
            var responseMessage = await client.PostAsync("https://localhost:7001/api/SocialMedias", stringContent);
        ...
        public async Task<IActionResult> DeleteSocialMedia(int id)
        {
            ...
            var responseMessage = await client.DeleteAsync($"https://localhost:7001/api/SocialMedias/{id}");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var responseMessage = await client.GetAsync($"https://localhost:7001/api/SocialMedias/{id}");//İlk olarak güncellemem gereken id yi bulmalıyım.
        ...
        public async Task<IActionResult> UpdateSocialMedia(UpdateSocialMediaDto updateSocialMediaDto)
        {
            ...
            var responseMessage = await client.PutAsync("https://localhost:7001/api/SocialMedias", stringContent);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
